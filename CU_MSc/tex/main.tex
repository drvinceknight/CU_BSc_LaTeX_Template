...
\fancypagestyle{chapterstyle}{
    ...
    \renewcommand{\footrulewidth}{0 pt}% Line at the footer visible
}
...
% Package to add features to for tables
\usepackage{multirow}
\usepackage{booktabs}
\setlength{\heavyrulewidth}{1.5pt}
\setlength{\abovetopsep}{4pt}

% Packages to allow sub-captioning
